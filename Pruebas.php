...
<html>
 ...
 -->        	
		...
		<form name="buscar" method="post" action="pruebas.php" class="d-flex">
			<select name="campo">
				<?
...
<!-- echo "<a class='btn btn-outline-success'type='submit' name='enviar'>Buscar</a>";
href='".$_SERVER['PHP_SELF']."?buscar=true' -->
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
 ...
 -->        	
		...
		<div class="mt-3" align="center">
			<a class="btn btn-danger" href="pruebas.php">Regresar</a></button>
		</div>
		<table id="texto" class="table table-dark table-striped table-hover mt-3" style="text-align: center; width: 800px; text-transform: capitalize;" align="center">
			<thead>
				<tr>
