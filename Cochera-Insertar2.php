...
$subs_estacion =utf8_decode($_POST['Estacion']);
  ...
  $insert_value ='INSERT INTO `' . $db_name . '`.`'.$db_table_name.'` (`ID_COCHERA`, `NOM_COCHERA`, `ID_ESTACION2`) VALUES ("' . $subs_id . '", "' . $subs_nombre . '","'.$subs_estacion.'")';                       
...
<html>
    	...
    	<body>
    		<script>alert("Registro Insertado");window.location="COCHERA.php";</script>
	</body>
	</html>
